...
import android.widget.SeekBar.OnSeekBarChangeListener;import com.koga.android.notenote.R;
...
public class ColorDialogFragment extends DialogFragment
{
   ...
   public Dialog onCreateDialog(Bundle bundle)
   {
      ...
      builder.setNegativeButton(R.string.button_set_color,
      ...
      builder.setPositiveButton(R.string.color_set_background,
    	         new DialogInterface.OnClickListener() 
    	         {
    	            public void onClick(DialogInterface dialog, int id) 
    	            {
